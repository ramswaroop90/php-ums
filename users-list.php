							...
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<div class="row mb-2">
											<div class="col-sm-12">
												<button type="button" class="btn btn-danger waves-effect waves-light float-end" data-bs-toggle="modal" data-bs-target="#custom-modal"><i class="mdi mdi-plus-circle me-1"></i> Add Customers</button>
											</div>
										</div>
														...
														while($user = $users->fetch_object())
														{
															...
															<tr>
																...
																<td class="table-user">
																	...
																	<a href="javascript:void(0);" class="text-body fw-semibold"><?php echo $user->name ?></a>
																</td>
																<td>
																	937-330-1634
																</td>
